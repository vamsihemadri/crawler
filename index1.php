            ...
            <div class="col-md-12">
                <div id="custom-search-input">
                    <div class="input-group col-md-12">
                        <input id="transcript" name="search" type="text" class="form-control input-lg" placeholder="Search" />
                        <span class="input-group-btn">
                            <button onclick="startDictation()" class="btn btn-info btn-lg" type="button">
      ...
      function startDictation() {
				...
				if (window.hasOwnProperty('webkitSpeechRecognition')) {
				  ...
				  recognition.onresult = function(e) {
				    ...
				    recognition.stop();
						searchq(1,1);
        		$("#output").html("<p>Searching for "+$("input[name='search']").val()+"</p>");
				  };
