		...
		if link in tobe_indexed_paths or link not in already_indexed_paths:
			...
			if link[-4:]=='.pdf':
				...
				with open(link[:-4]+".txt",'r') as f:
					...
					#print "stage 1 for pdfs"
					writer.commit()
					#print "stage 2 for pdfs"
			...
			if(page.info().type == 'text/html'):
				...
				#### SOME HOW GET THE TIME INT THE FORMAT THIS HEADER UNDERSTAND
				## I guess the current format works well, incase??
